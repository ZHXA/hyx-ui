...
<template>
 <div :class="cls" :style="style">
   <img  v-if="!playing&&poster" class="hyx-video__play" :src="play" alt="" @click.stop="handleToPlay">
   <!--<i :class="icon"  class="hyx-video__type" ></i>-->
   <video
     ref="video"
     v-show="show"
     controls
   ...
   <div class="hyx-video__time" v-if="poster">{{this.duration}}</div>
 </div>
</template>
