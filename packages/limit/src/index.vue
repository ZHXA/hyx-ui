...
<template>
  <div class="hyx-textarea" v-if="type==='textarea'">
    <textarea
      :style="[getInnerTextAreaStyle]"
      class="hyx-textarea__inner"
      ref="textarea"
      :value="value"
      :rows="rows"
      v-bind="$attrs"
      ...
      @blur="focus=false"
    />
    <span class="hyx-textarea__textOver"  >
    <span :class="{'hyx-textarea--isOver':isOver}">{{count}}</span>/<span>{{limit}}</span>
    </span>
  </div>
  <div class="hyx-input" v-else

       @mouseenter="hovering = true"
       @mouseleave="hovering = false"
  >
    <input
      class="hyx-input__inner"
      :value="value"
      :disabled="disabled"
      :placeholder="placeholder"
      ...
      @blur="focus=false"
    />
    <span class="hyx-input__count" >
      <span :class="{'hyx-textarea--isOver':isOver}">{{count}}</span>/<span>{{limit}}</span>
   </span>
    <div class="hyx-input__tip" v-if="tip">{{tip}}</div>
  </div>
