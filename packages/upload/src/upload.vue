...
<template>
  <div :class="cls">
      <div class="hyx-upload__button" @click="checkedFile">
        <slot name="trigger">
      ...
      <input type="file"  name="file" class="hyx-upload__input"  v-show="false" ref="upload" @change="uploadFiles">
