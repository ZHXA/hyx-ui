...
<template>
  ...
  <div :class="cls" >
      <div class="hyx-audio__defaultCover"  :style="style"   ></div>
      <i :class="icon" class="hyx-audio__type"></i>
      <img class="hyx-audio__play" :src="palyOrStop" alt="" @click.stop="handleToPlay">
      <audio ref="audio"
             class="audio"
      ...
      <div class="hyx-audio__time">{{this.audioDuration}}</div>
  </div>
...
export default {
  ...
  computed: {
    cls () {
      return classnames('hyx-audio', {'hyx-audio--disabled': this.playing})
    },
    palyOrStop () {
