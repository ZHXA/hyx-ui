...
<template>
   <div class="hyx-swiper swiper-no-swiping" @click="swiperClick($event)">
     <!--<div class="hyx-swiper__totalBox">共<span class="hyx-swiper__num">{{data.length}}</span>张</div>-->
     ...
     <div class="swiper-pagination" slot="pagination" :class="{'hyx-show':cardLength>=cardShowNumber}"></div>
     <div class="swiper-button-prev hyx-swiper__button " slot="button-prev" :class="{'hyx-show':cardLength>=cardShowNumber}">
       <i class="el-icon-arrow-left"></i>
     </div>
     <div class="swiper-button-next hyx-swiper__button " slot="button-next" :class="{'hyx-show':cardLength>=cardShowNumber}">
